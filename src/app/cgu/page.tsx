  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="mt-12 glass rounded-2xl p-6 flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        <Link href="/contact" className="inline-flex items-center gap-2 bg-primary text-white px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-primary-dark transition">
